...
class CompetitiveConditions(object):
    ...
    def get_outcomes(self, jb_price, demand_level, jb_demand_signal,
        ...
        if self.model_based_simulation:
            ...
            jb_qty, delta_qty = (probabilistic_round(preds[i][0]) for i in ['jb_qty_sold', 'delta_qty_sold'])
            delta_price = preds['delta_price'] if 'delta_price' in preds else np.nan
...
def probabilistic_round(num):
    ...
    '''
    # TODO: Find better place to put this fn
    int_val = int(num)
